...
$tsql = "Select TeacherNo,Name,Phoneno,address1,address2,city,email from Staff where SchoolNo = '".$SchoolNoLocal."' and boardmember = 1 order by Name";     
...
$data = "<table id='grid-selection' class='table table-condensed table-hover table-striped'>
    <thead>
        <tr>
            <th  data-column-id='TeacherNo' data-identifier='true'>Staff #</th>
...
$smarty->display('smart_admin_schoolprofile.tpl');
