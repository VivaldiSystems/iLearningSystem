          ...
          <li class="dropdown">
             ...
             <li class="divider"></li> 
                ...
                &nbsp;&nbsp;Logout
                     ...
                     <li class="divider"></li> 
                      <li>
                <a href="smart_admin_schoolprofile.php">
                <i class="fa fa-dashboard"></i> 
                &nbsp;&nbsp;School Profile
                </a>
              </li>
              ...
              <li>
                <a href="smart_admin_studentaccounts.php">
                <i class="fa fa-dashboard"></i> 
                &nbsp;&nbsp;Students Accounts
                </a>
              </li>
              ...
              <li>
                <a href="smart_admin_teachers.php">
                <i class="fa fa-dashboard"></i> 
                &nbsp;&nbsp;Teacher Manager
                </a>
              </li>
                     <li>
                <a href="smart_admin_staff.php">
                <i class="fa fa-dashboard"></i> 
                &nbsp;&nbsp;Staff Manager
                </a>
              </li>
                <li>
                <a href="smart_admin_parents.php">
                <i class="fa fa-dashboard"></i> 
                &nbsp;&nbsp;Parent Manager
                </a>
              </li>
                <li>
                <a href="smart_admin_studentregistration.php">
                <i class="fa fa-dashboard"></i> 
                &nbsp;&nbsp;Registration
                </a>
              </li>
                ...
                <li>
                <a href="smart_admin_parentpta.php">
                <i class="fa fa-dashboard"></i> 
                &nbsp;&nbsp;PTA Manager
                </a>
              </li>
               ...
               <li>
                <a href="smart_admin_boardmember.php">
                <i class="fa fa-dashboard"></i> 
                &nbsp;&nbsp;Board Manager
                </a>
              </li>
