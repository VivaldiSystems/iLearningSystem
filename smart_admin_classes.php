...
$tsql = "Select ClassNo,Code,Class,(Select Name from Teacher where Teacher.TeacherNo = Class.TeacherNo) As Teacher,Room,Period,ExtendedCode from class where SchoolNo  = '".$SchoolNoLocal."'  And classyears = '".$_COOKIE['schoolyear']."' AND SEMESTER = '".$_COOKIE['schoolterm']."'  AND TEACHERNO = '".$_COOKIE['schoolteacher']."' ORDER BY Code ";     
}
...
$data = "<table id='grid-selection' class='table table-condensed table-hover table-striped'>
    <thead>
        <tr>
            <th  data-column-id='ClassNo' data-identifier='true'>Class #</th>
             <th data-formatter='link' data-column-id='Code'>Code</th>
             <th data-column-id='Description' >Description</th>
             <th data-column-id='Teacher' >Teacher</th>
             <th data-column-id='Room' >Room</th>
             <th data-column-id='Period' >Period</th>
             <th data-column-id='ExtendedCode' >ExtendedCode</th>
