        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
            ...
            <div class="portlet">
              ...
              <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Class Parents
              ...
              <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Class Students
             ...
             <div class="list-group">      
                  ...
                  <a href="smart_account_classes.php" class="btn btn-secondary"><< Back</a>&nbsp;&nbsp;
                    ...
                    <tr>
                      ...
                      <div class="fileupload-new thumbnail" style="width: 250px; height: 250px;">
                        ...
                        <span class="btn btn-default btn-file">
                          <span class="fileupload-new">Select New image</span>
