...
$tsql = "Select TeacherNo,Name,Phoneno,address1,address2,city,email from Teacher where SchoolNo = '".$SchoolNoLocal."' order by Name";     
...
$data = "<table id='grid-selection' class='table table-condensed table-hover table-striped'>
    <thead>
        <tr>
            <th  data-column-id='TeacherNo' data-identifier='true'>Teacher</th>
             <th data-column-id='Teacher'>Name</th>
             <th data-column-id='Phoneno' >Phone</th>
             <th data-column-id='Address1' >Address</th>
             <th data-column-id='Address2' >Address</th>
...
{	
	...
	$data  = $data . "<th style='width: 30%'>".$row[1]."</th>";
	$data  = $data . "<th style='width: 10%'>".$row[2]."</th>";
	$data  = $data . "<th style='width: 15%'>".$row[3]."</th>";
	$data  = $data . "<th style='width: 15%'>".$row[4]."</th>";
...
$smarty->display('smart_admin_teachers.tpl');
