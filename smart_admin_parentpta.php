...
$tsql = "Select ParentNo,Parent,Phoneno,address1,address2,city,email from Parent where SchoolNo = '".$SchoolNoLocal."' And PTA = 1 order by Parent";     
...
$data = "<table id='grid-selection' class='table table-condensed table-hover table-striped'>
    <thead>
        <tr>
            <th  data-column-id='ParentNo' data-identifier='true'>Parent #</th>
             <th data-column-id='Parent'>Name</th>
...
$smarty->display('smart_admin_parents.tpl');
