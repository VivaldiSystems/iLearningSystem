...
$tsql = "Select StudentNo,Student,Phoneno,address1,address2,city,email from Student where SchoolNo = '".$SchoolNoLocal."' order by Student";     
...
$data = "<table id='grid-selection' class='table table-condensed table-hover table-striped'>
    <thead>
        <tr>
            <th  data-column-id='StudentNo' data-identifier='true'>Student #</th>
             <th data-column-id='Student'>Name</th>
...
{	
	...
	$data  = $data . "<tr class='special' style='font-size:10px'><th style='width: 10%'><a href='javascript:OpenStudentEdit(".$row[0].");' >".$row[0]."</a></th>";
...
$smarty->display('smart_admin_studentregistration.tpl');
